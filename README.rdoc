...
For my final project I made an convenient but easy-to-use notetaking app called Scribbar. Mostly meant for students, this app enables its users to store their
...
Addons : This app makes use of two different addons. 
...
The CSS features make the site more attractive and Jquery is used to make the Note Accordion (A standard jquery accordion, documentation
 available at http://jqueryui.com/accordion/) in Notes index, and also to preview new notes by tracking keystrokes in the note-body area.
